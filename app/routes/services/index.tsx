    ...
    <div className="space-y-16">
      ...
      <section className="space-y-12">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <img src="/images/dev-placeholder.jpg" alt="Web development" className="rounded-xl shadow-md" />
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center md:flex-row-reverse">
          ...
          <img src="/images/design-placeholder.jpg" alt="Branding" className="rounded-xl shadow-md" />
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <img src="/images/social-placeholder.jpg" alt="Social media marketing" className="rounded-xl shadow-md" />
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center md:flex-row-reverse">
          ...
          <img src="/images/photography-placeholder.jpg" alt="Photography" className="rounded-xl shadow-md" />
        </div>
      </section>
    </div>
  );
